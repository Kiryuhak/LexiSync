...
const REQUIRED_ORIGINS = ['https://api.mistral.ai/*', 'https://ngw.devices.sberbank.ru/*', 'https://api.giga.chat/*'];
...
for (const browser of ['chrome', 'firefox']) {
    ...
    if (!sameValues(requiredOrigins, REQUIRED_ORIGINS))
        throw new Error(`${browser}: обязательный доступ разрешён только для Mistral API и GigaChat API`);
