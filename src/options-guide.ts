...
export const GUIDE_DEMOS: GuideFeatureDemo[] = [
    ...
    },
    {
        ...
        tip: 'Совет: Во вкладке «AI и расход» можно выбрать экономный или сбалансированный режим и установить защитные лимиты.',
    },
    {
        id: 'inplace',
        number: '3',
    ...
    },
    {
        ...
        number: '14',
        icon: '📝',
        title: 'Заметки в связный текст',
        shortcut: 'Заметки в текст',
