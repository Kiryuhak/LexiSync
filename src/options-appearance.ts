...
export function updateAppearancePreview(): void {
    ...
    renderCompactResultPreview(
        compactResultPreview,
        {
            ...
            tabImprove: t('quickTabImprove', 'Улучшить'),
            tabRephrase: t('quickTabRephrase', 'Перефразировать'),
            tabShorten: t('quickTabShorten', 'Сократить'),
            dismiss: t('dismissCorrection', 'Отклонить'),
        },
