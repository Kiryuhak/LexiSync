...
- **Гибридная проверка текста:** Яндекс.Спеллер первым проверяет орфографию. Если остаются контекстные, грамматические или неоднозначные случаи, исправленный Спеллером текст передаётся выбранному AI.
