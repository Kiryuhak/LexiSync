...
*   **🛡️ Доступ только по запросу:** Постоянный доступ выдаётся отдельно для текущего сайта через popup; Mistral API остаётся единственным обязательным внешним адресом.
