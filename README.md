...
- **📚 Более понятные настройки:** галерея шаблонов стала ровнее и читабельнее, инструкции — компактнее, а длинные названия функций руководства больше не ломают строку.
