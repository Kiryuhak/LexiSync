...
Версия 4.1 развивает рабочее пространство для текста:

- боковая панель в Chrome и Firefox с командной палитрой (`Ctrl/Cmd + K`);
- цепочки из нескольких AI-шагов и пользовательский конструктор цепочек;
- три альтернативных варианта каждого результата;
- фоновая проверка текста при вводе с зелёной подсветкой исправлений;
- пакетная обработка TXT и Markdown;
- пауза, продолжение после повторного открытия и повтор неудачных пакетных файлов;
...
Открыть рабочую панель можно из popup расширения. Все новые параметры находятся на вкладках «Рабочая панель» и «Оформление» в настройках.
