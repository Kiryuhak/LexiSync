...
- Горячие клавиши теперь работают с текстом во встроенных редакторах и учебных заданиях.
- История сообщает об успешных действиях и понятным текстом объясняет ошибки.
- «Повторить на странице» подсказывает, если подходящая веб-страница не открыта.
- Кнопки защищены от случайного двойного запуска, а экспорт JSON стал надёжнее в Firefox.
