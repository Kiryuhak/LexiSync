...
- **Автоматическая проверка:** GitHub Actions запускает ESLint, TypeScript, модульные тесты с покрытием, функциональные сценарии Chrome и runtime-проверку Firefox.
