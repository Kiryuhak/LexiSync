...
- Расширение получило понятное название «Корректор грамматики и орфографии - LexiSync».
- Английское название локализовано как «Grammar and Spell Checker - LexiSync».
- Название согласовано в магазине, списке расширений и подсказке кнопки браузера.
